...
public class License {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("key", key).append("name", name).append("spdxId", spdxId).append("url", url).append("nodeId", nodeId).append("additionalProperties", additionalProperties).toString();
    }
